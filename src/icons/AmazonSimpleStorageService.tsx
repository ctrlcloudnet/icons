...
interface AmazonS3IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string; // Optional override for background
  title?: string;
}

export const AmazonS3Icon: React.FC<AmazonS3IconProps> = ({
  size = 40,
  color = '#7AA116',
  title = 'Amazon S3 Icon',
  ...props
}) => (
  <svg
    width={size}
