...
interface AmazonEC2IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  title?: string;
}

export const AmazonEC2Icon: React.FC<AmazonEC2IconProps> = ({
  size = 40,
  color = '#ED7100', // Default to the original orange color
  title = 'Amazon EC2 Icon',
  ...props
}) => (
  <svg
    width={size}
  ...
  >
    ...
    <g id="Icon-Architecture/32/Arch_Amazon-EC2_32" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="Icon-Architecture-BG/32/Compute" fill={color}>
